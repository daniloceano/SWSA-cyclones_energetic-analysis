...
id = f"{year}0297"
month = "05"
track_file_raw = f'../../SWSA-cyclones_energetic-analysis/raw_data/TRACK_BY_RG-20230606T185429Z-001/24h_1000km_add_RG1_csv/ff_trs_neg_ExSAt_{year}{month}_joint_mslp_10spd_GenRG1.csv'
...
track_id = track[track['track_id'] == int(id)]
